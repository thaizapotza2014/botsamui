...
cred = credentials.Certificate("test-bot-xmqalp-firebase-adminsdk-lryb2-44c202f159.json")
...
#ใช้แยกแยกแยะ Intent name ไปยัง Function เฉพาะที่จะประมวลผล Intent Name นั้นๆ
def generating_answer(question_from_dailogflow_dict): 
    ...
    #เลือก Intent เพื่อส่งกลับไปยัง Dialogflow
